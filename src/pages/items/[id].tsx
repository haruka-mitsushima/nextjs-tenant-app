...
export default function ItemPage({
  ...
  //     itemData.options[0].description
  //   );
  ...
  //     itemData.options[1].description
  //   );
  ...
  //     itemData.options[2].description
  //   );
  ...
  const info = {
    ...
    //     id: opId1,
    //     name: opName1,
    //     description: opDescription1,
    //     price: opPrice1,
    //   },
    //   {
    //     id: opId2,
    //     name: opName2,
    //     description: opDescription2,
    //     price: opPrice2,
    //   },
    //   {
    //     id: opId3,
    //     name: opName3,
    //     description: opDescription3,
    //     price: opPrice3,
    //   },
    // ],
  };
  ...
  return (
    <div>
      ...
      <div>
        合計金額　{itemData.price}
        {/* +{itemData.options[0].price}+
        {itemData.options[1].price}+{itemData.options[2].price} */}
      </div>
      {/* <h2>オプション</h2>
      ...
      <form method="PUT" id="update" onSubmit={send}>
        ...
        <label htmlFor="opName">
          ...
          <input
            ...
            id="opName1"
            value={opName1}
            onChange={(e) => setOpName1(e.target.value)}
          />
        </label>
        <br />
        <label htmlFor="opDescription">
          ...
          <input
            type="text"
            id="opDescription1"
            value={opDescription1}
            onChange={(e) => setOpDescription1(e.target.value)}
          />
        </label>
        <br />
        <label htmlFor="opPrice">
          ...
          <input
            ...
            id="opPrice1"
            value={opPrice1}
            onChange={(e) => setOpPrice1(Number(e.target.value))}
          />
        </label>
        <br />
        <br />
        ...
        <label htmlFor="opName">
          ...
          <input
            ...
            id="opName2"
            value={opName2}
            onChange={(e) => setOpName2(e.target.value)}
          />
        </label>
        <br />
        <label htmlFor="opDescription">
          ...
          <input
            type="text"
            id="opDescription2"
            value={opDescription2}
            onChange={(e) => setOpDescription2(e.target.value)}
          />
        </label>
        <br />
        <label htmlFor="opPrice">
          ...
          <input
            ...
            id="opPrice2"
            value={opPrice2}
            onChange={(e) => setOpPrice2(Number(e.target.value))}
          />
        </label>
        <br />
        <br />
        ...
        <label htmlFor="opName">
          ...
          <input
            ...
            id="opName3"
            value={opName3}
            onChange={(e) => setOpName3(e.target.value)}
          />
        </label>
        <br />
        <label htmlFor="opDescription">
          ...
          <input
            type="text"
            id="opDescription3"
            value={opDescription3}
            onChange={(e) => setOpDescription3(e.target.value)}
          />
        </label>
        <br />
        <label htmlFor="opPrice">
          ...
          <input
            ...
            id="opPrice3"
            value={opPrice3}
            onChange={(e) => setOpPrice3(Number(e.target.value))}
          />
        </label> */}
        <br />
